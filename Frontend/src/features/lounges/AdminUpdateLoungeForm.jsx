...
function AdminUpdateLoungeForm({ lounge }) {
  ...
  useEffect(() => {
    if (isSuccess) {
      alert("You've successfully this users your lounge!");
      navigate(-1);
    }
    if (isDeleteSuccess) {
      alert("You've successfully deleted this users your lounge!");
      navigate(-1);
    }
...
AdminUpdateLoungeForm.propTypes = {
  lounge: PropTypes.object.isRequired,
};

export default AdminUpdateLoungeForm;
